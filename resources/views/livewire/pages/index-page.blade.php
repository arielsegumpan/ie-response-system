    ...
    @push('scripts')
        <script>
            ...
            window.addEventListener('load', () => {
                ...
                // function createPopupContent(inc_name, created_at, $images) {
                //     let imagesHtml = '';
                //     if (Array.isArray(images)) {
                //         imagesHtml = images.map(img => {
                //             return `<img class="inline-block size-8 rounded-lg m-1" src="${img.image_path}" alt="Incident Image">`;
                //         }).join('');
                //     }
                ...
                //                 <img class="inline-block size-8 rounded-lg" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=300&h=300&q=80" alt="Avatar">
                //                 <span class="absolute top-0 end-0 block size-1.5 rounded-full transform -translate-y-1/2 translate-x-1/2 ring-2 ring-white bg-gray-400 dark:ring-neutral-900"></span>
                //             </div>
                //         </div>
                //     </div>
                //     `;
                ...
                function createPopupContent(inc_name, created_at, imageArray) {
                    ...
                    if (Array.isArray(imageArray)) {
                        imagesHtml = imageArray.map(img => {
                            return `<img class="inline-block size-8 rounded-lg border-1 border-red-800" src="${img.image_url}" alt="Incident Image">`;
                        }).join('');
